...
EMBEDDING=embeddings/foldseek_emb.h5
OUTPUT_FOLDER=original_human_model_dscript_fseek
...
dscript train --train $TRAIN --test $TEST --embedding $EMBEDDING $TOPSY_TURVY \
              ...
              --lr 0.001 --lambda 0.05 --num-epoch 10 --input-dim 21 \
              --weight-decay 0 --batch-size 25 --pool-width 9 \
              --kernel-width 7 --dropout-p 0.2 --projection-dim 100 \
              --hidden-dim 50 --kernel-width 7 --device $DEVICE --ignore-proteins-without-embedding


# Remove these {'9606.ENSP00000357676',
#  '9606.ENSP00000386340',
#  '9606.ENSP00000411070',
#  '9606.ENSP00000415758',
#  '9606.ENSP00000419682'} proteins 
