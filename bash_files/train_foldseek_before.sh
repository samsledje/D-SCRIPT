...
OUTPUT_FOLDER=fseek_before_human_model_dscript
...
dscript train --train $TRAIN --test $TEST --embedding $EMBEDDING $TOPSY_TURVY \
              ...
              --hidden-dim 50 --kernel-width 7 --device $DEVICE --allow_foldseek --foldseek_fasta ${FOLDSEEK_FASTA} --foldseek_vocab ${FOLDSEEK_VOCAB} 
              #  --add_foldseek_after_projection # This is unset