...
def predict_interaction(model, n0, n1, tensors, use_cuda,
    ...
    """
    if mode == "train_cmap":
        predict_cmap_interaction(model, n0, n1, tensors, use_cuda, 
                                        allow_foldseek, fold_record, fold_vocab, add_first,
                                         mode, sampler, expected_samples, lossfn, optim
                                       )
        return
...
def train_model(args, output):
    ...
    train_dataset = PairedDataset(train_p1, train_p2, train_y, args.allow_geom_loss, args.geom_cmap)
    ...
    test_dataset = PairedDataset(test_p1, test_p2, test_y, args.allow_geom_loss, args.geom_cmap)
