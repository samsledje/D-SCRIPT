...
class PairedEmbeddingDataset(Dataset):
    ...
    def __getitem__(self, i):
        return (self.embedding[self.x0.iloc[i]],
...
class PPIDataModule(pl.LightningDataModule):
    ...
    def prepare_data(self):
        ...
        if not self.sequence_path.suffix == '.h5':
            ...
            embed_from_fasta(self.sequence_path, self.sequence_path.with_suffix('.h5'), verbose=True)
    ...
    def setup(self, stage: Optional[str] = None):
        ...
        self.train_df, self.val_df = train_test_split(self.full_df,
        ...
        self.data_val = PairedEmbeddingDataset(
            self.val_df, self.embeddings
        )
