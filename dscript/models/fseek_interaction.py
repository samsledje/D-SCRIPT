...
class ModelInteractionFseek(nn.Module):
    def __init__(
        self,
        embedding,
        contact,
        ...
        """
        super(ModelInteractionFseek, self).__init__()
        ...
        ### Foldseek embedding here
        self.fseek_emb = nn.Embedding(21, fseek_lang)
    ...
    def cpred(self, z0, z1, f0, f1):
        ...
        f0 = self.fseek_emb(f0)
        f1 = self.fseek_emb(f1)
    ...
    def predict(self, z0, z1, f0, f1):
        ...
        :rtype: torch.Tensor, torch.Tensor
        """
        _, phat = self.map_predict(z0, z1, f0, f1)
        return phat

    def forward(self, z0, z1, f0, f1):
        """
        :meta private:
        """
        return self.predict(z0, z1, f0, f1)
